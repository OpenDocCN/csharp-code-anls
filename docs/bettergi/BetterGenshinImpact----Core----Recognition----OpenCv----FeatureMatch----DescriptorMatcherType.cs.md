# `.\better-genshin-impact\BetterGenshinImpact\Core\Recognition\OpenCv\FeatureMatch\DescriptorMatcherType.cs`
...
public enum DescriptorMatcherType
{
    ...
    // 使用 FLANN（Fast Library for Approximate Nearest Neighbors）库的描述符匹配器
    FlannBased
